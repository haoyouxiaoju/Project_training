<template>
  <div class="login-container">
    <div style="color: #39bf23; font-size: 50px; font-weight: bold; position: absolute; text-align: center; top: 50px">茶叶销售系统</div>
    <div class="login-box">
...
.login-container {
  ...
  align-items: center;
  background-image: url("@/assets/imgs/teasts.png");
