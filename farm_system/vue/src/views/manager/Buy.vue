<template>
  <div style="padding-bottom: 50px">
    ...
    <div style="margin-bottom: 10px">
      ...
      <el-button :class="{ 'active' : data.activeCategoryId === null }" @click="loadCategoryGoods(null)">搜索</el-button>
    </div>
    ...
    <div style="padding: 50px 0; text-align: center; font-size: 24px; color: #888" v-else>暂无茶叶...</div>
